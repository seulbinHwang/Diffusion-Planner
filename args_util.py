...
def get_args():
    ...
    parser.add_argument('--p_const_sat', type=float, help='p_sat', default=1.)
    ...
    parser.add_argument('--use_body_vel', default=False, type=boolean)
    ...
    parser.add_argument('--integration_yaw_weight', default=1., type=float)
    ...
    parser.add_argument('--train_epochs',
                        ...
                        default=550)
    parser.add_argument('--ca_topk_k', type=int, help='ca_topk_k', default=64)
    ...
    parser.add_argument('--eval_temperature', type=float, default=0.2)
