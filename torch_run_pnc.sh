...
###################################
RUN_PYTHON_PATH="/media/user/E/miniforge/envs/diffusion_planner/bin/python"
TRAIN_SET_PATH="/media/user/D/dataset/processed"   # 디렉터리 자체는 유지, 내용만 비움
TRAIN_SET_LIST_PATH="/media/user/E/projects/Diffusion-Planner/diffusion_planner_training.json"
###################################
