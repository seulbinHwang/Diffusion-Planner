...
class DiffusionPlannerData(Dataset):
    ...
    def __getitem2__(self, idx):
        ...
        near_future_gt_3_dim = data[
            "neighbor_future_gt_3_dim"][:self._predicted_neighbor_num]
        # (num_agents, future_len, 3) -> (predicted_neighbor_num, future_len, 3)
        near_future_cont_gt = data["neighbor_future_cont_gt"][:self._predicted_neighbor_num]
        ...
        data = {
            ...
            "near_future_cont_gt": near_future_cont_gt,  # 12
            ### 유일하게 key 이름이 다름.
            "planner_future_11_dim": ego_future_gt_11_dim,  # 13
            "agent_route_lane_order": agent_route_lane_order,  # 14
        }
