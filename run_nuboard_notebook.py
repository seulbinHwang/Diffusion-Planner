...
NUPLAN_DIR=f"{HOME_DIR}/nuplan"
# RESULT_FOLDER: str = /home/user/nuplan/exp/simulation/log_replay_reactive_diffusion_agents/val14_mini/CHALLENGE/npc_model_2025-09-30-18-04-00
RESULT_FOLDER: str = f"{NUPLAN_DIR}/exp/simulation/log_replay_reactive_diffusion_agents/val14_mini/CHALLENGE/npc_model_2025-10-01-11-01-42"
...
ENV_VARS: Dict[str, str] = {
    ...
    "NUPLAN_DATA_ROOT":  f"{NUPLAN_DIR}/dataset",
    "NUPLAN_MAPS_ROOT": f"{NUPLAN_DIR}/dataset/maps",
    "NUPLAN_EXP_ROOT":  f"{NUPLAN_DIR}",
