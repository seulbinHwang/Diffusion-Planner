...
from nuplan_extent.planning.simulation.runner.simulations_runner import SimulationRunner
...
def build_simulations(
    ...
    if not int(os.environ.get("NUPLAN_SIMULATION_ALLOW_ANY_BUILDER",
                              "0")) and not is_target_type(
